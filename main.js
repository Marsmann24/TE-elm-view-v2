								...
								return function (decoder7) {
									return function (decoder8) {
										return function (decoder9) {
											return function (decoder10) {
												return function (decoder11) {
													return A3(
														_elm_lang$core$Json_Decode$map2,
														F2(
															function (a, b) {
																return $function(a.a0)(a.a1)(a.a2)(a.a3)(a.a4)(a.a5)(b.b0)(b.b1)(b.b2)(b.b3)(b.b4)(b.b5);
															}),
														A7(
															_elm_lang$core$Json_Decode$map6,
															F6(
...
var _user$project$Decoderhelper$float2 = function () {
	var convert = function (a) {
		return A2(
			_elm_lang$core$Result$withDefault,
			0,
			_elm_lang$core$String$toFloat(a));
	};
...
var _user$project$Term$Term = F6(
	function (a, b, c, d, e, f) {
		return {id: a, name: b, wordtype: c, count: d, relevance: e, top_topic: f};
	});
var _user$project$Term$defaultTerm = A6(
	...
	_elm_lang$core$Maybe$Nothing,
	{ctor: '[]'});
var _user$project$Term$matchTermsBySorting = function (termsorting) {
	var term = function (x) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			_user$project$Term$defaultTerm,
			A2(_elm_lang$core$Dict$get, x.id, termsorting.items));
	};
	var matchTerm = function (x) {
		var term_ = term(x);
		return _elm_lang$core$Native_Utils.update(
			term_,
			{
				relevance: _elm_lang$core$Maybe$Just(x.relevance)
			});
	};
	return A2(_elm_lang$core$List$map, matchTerm, termsorting.sorting);
};
var _user$project$Term$matchTermsById = function (termsorting) {
	var toTermSortingItem = function (id) {
		return {id: id, relevance: 0};
	};
	var sorting = {
		items: termsorting.items,
		sorting: A2(_elm_lang$core$List$map, toTermSortingItem, termsorting.sorting)
	};
	return _user$project$Term$matchTermsBySorting(sorting);
};
var _user$project$Term$matchTermsortingById = function (termsresult) {
	var termsorting = {
		items: termsresult.terms,
		sorting: _elm_lang$core$Tuple$second(termsresult.topic)
	};
	return _user$project$Term$matchTermsBySorting(termsorting);
};
var _user$project$Term$termDecoder = F2(
	function (itemName, intDecoder) {
		return A7(
			_elm_lang$core$Json_Decode$map6,
			_user$project$Term$Term,
			A2(
				_elm_lang$core$Json_Decode$field,
				A2(_elm_lang$core$Basics_ops['++'], itemName, '_ID'),
				intDecoder),
			A2(
				_elm_lang$core$Json_Decode$field,
				A2(_elm_lang$core$Basics_ops['++'], itemName, '_NAME'),
				_elm_lang$core$Json_Decode$string),
			_elm_lang$core$Json_Decode$maybe(
				A2(_elm_lang$core$Json_Decode$field, 'WORDTYPE$WORDTYPE', intDecoder)),
			_elm_lang$core$Json_Decode$maybe(
				A2(
					_elm_lang$core$Json_Decode$field,
					A2(_elm_lang$core$Basics_ops['++'], itemName, '_COUNT'),
					intDecoder)),
			_elm_lang$core$Json_Decode$maybe(
				A2(_elm_lang$core$Json_Decode$field, 'RELEVANCE', intDecoder)),
			A2(
				_elm_lang$core$Json_Decode$map,
				_elm_lang$core$Maybe$withDefault(
					{ctor: '[]'}),
				...
				_user$project$Decoderhelper$pseudolist(
					A3(
						...
						A2(
							...
							_user$project$Term$defaultTerm,
							A2(_user$project$Term$termDecoder, 'ITEM', _elm_lang$core$Json_Decode$int))))))));
var _user$project$Term$searchTermDecoder = _elm_lang$core$Json_Decode$list(
	A2(_user$project$Term$termDecoder, 'TERM', _user$project$Decoderhelper$int2));
	...
	A3(
		...
		A2(
			...
			A2(
				_user$project$Decoderhelper$intDictDecoder,
				_user$project$Term$defaultTerm,
				A2(_user$project$Term$termDecoder, 'TERM', _elm_lang$core$Json_Decode$int)))));
...
var _user$project$Topic$defaultTopicHirarchie = A4(_user$project$Topic$TopicHirarchie, 0, 0, 0, _elm_lang$core$Maybe$Nothing);
	...
	function (docs, docId) {
		return _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (x) {
					return _elm_lang$core$Native_Utils.eq(x.id, docId);
				},
				docs));
	});
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {id: a, keyword_snippet: b, keyword_title: c, top_topic: d, linkurl: e, time_stamp: f, title: g, snippet: h, topic_id: i, document_count: j, relevance: k, isino: l};
											};
										};
									};
								};
...
var _user$project$Document$defaultDoc = _user$project$Document$Doc(0)('')('default')(
	{ctor: '[]'})('url')(0)('default')('')(_elm_lang$core$Maybe$Nothing)(_elm_lang$core$Maybe$Nothing)(_elm_lang$core$Maybe$Nothing)(_elm_lang$core$Maybe$Nothing);
var _user$project$Document$bestDocsDecoder = function () {
		...
		function (docs, docId) {
			return _elm_lang$core$List$head(
				A2(
					_elm_lang$core$List$filter,
					function (a) {
						return _elm_lang$core$Native_Utils.eq(a.id, docId);
					},
					docs));
		});
	var applySorting = F2(
	...
	var documents = A2(
		...
		'DOCUMENT',
		_user$project$Decoderhelper$pseudolist(
			_user$project$Decoderhelper$map12(_user$project$Document$Doc)(
				...
				_elm_lang$core$Json_Decode$maybe(
					A2(_elm_lang$core$Json_Decode$field, 'RELEVANCE', _user$project$Decoderhelper$float2)))(
				_elm_lang$core$Json_Decode$maybe(
					A2(_elm_lang$core$Json_Decode$field, 'ISIN0', _user$project$Decoderhelper$int2)))));
...
var _user$project$Document$defaultDocument = A8(
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {topics: a, docs: b, terms: c, settings: d, slots: e, answer: f, termsCache: g, termsDict: h, docsCache: i, docsDict: j, mdl: k};
										};
									};
								};
							};
...
var _user$project$Model$Settings = F7(
	function (a, b, c, d, e, f, g) {
		return {error: a, mobile: b, showRelevance: c, search: d, search4: e, searchResult: f, frame: g};
	});
...
var _user$project$Model$ViewTopics = {ctor: 'ViewTopics'};
var _user$project$Model$Mobile = {ctor: 'Mobile'};
var _user$project$Model$Startpage = {ctor: 'Startpage'};
var _user$project$Model$ErrorSlot = {ctor: 'ErrorSlot'};
var _user$project$Model$Empty = function (a) {
	return {ctor: 'Empty', _0: a};
};
var _user$project$Model$DocsContainerSlot = function (a) {
	return {ctor: 'DocsContainerSlot', _0: a};
};
var _user$project$Model$TermsContainerSlot = F2(
	function (a, b) {
		return {ctor: 'TermsContainerSlot', _0: a, _1: b};
	});
var _user$project$Model$CombinedView = F3(
	function (a, b, c) {
		return {ctor: 'CombinedView', _0: a, _1: b, _2: c};
	});
var _user$project$Model$ShowdocumentView = function (a) {
	return {ctor: 'ShowdocumentView', _0: a};
};
var _user$project$Model$TermsDocumentsView = F3(
	function (a, b, c) {
		return {ctor: 'TermsDocumentsView', _0: a, _1: b, _2: c};
	});
...
var _user$project$Msg$CombineDoc = F3(
	function (a, b, c) {
		return {ctor: 'CombineDoc', _0: a, _1: b, _2: c};
	});
var _user$project$Msg$CombineTopic = F3(
	function (a, b, c) {
		return {ctor: 'CombineTopic', _0: a, _1: b, _2: c};
	});
var _user$project$Msg$Combine = F3(
	function (a, b, c) {
		return {ctor: 'Combine', _0: a, _1: b, _2: c};
	});
var _user$project$Msg$BatchCmd = function (a) {
	return {ctor: 'BatchCmd', _0: a};
};
var _user$project$Msg$Batch = function (a) {
...
var _user$project$Msg$ManageDocsCache = function (a) {
	return {ctor: 'ManageDocsCache', _0: a};
};
var _user$project$Msg$NewDocsContainerSlot = F5(
	function (a, b, c, d, e) {
		return {ctor: 'NewDocsContainerSlot', _0: a, _1: b, _2: c, _3: d, _4: e};
	});
var _user$project$Msg$ManageTermsCache = function (a) {
	return {ctor: 'ManageTermsCache', _0: a};
};
var _user$project$Msg$NewTermsContainerSlot = F6(
	function (a, b, c, d, e, f) {
		return {ctor: 'NewTermsContainerSlot', _0: a, _1: b, _2: c, _3: d, _4: e, _5: f};
	});
var _user$project$Msg$ReturnDocs = F4(
	function (a, b, c, d) {
		return {ctor: 'ReturnDocs', _0: a, _1: b, _2: c, _3: d};
	});
var _user$project$Msg$ReturnTerms = F4(
	function (a, b, c, d) {
		return {ctor: 'ReturnTerms', _0: a, _1: b, _2: c, _3: d};
	});
var _user$project$Msg$NewSearchDocs = F2(
	function (a, b) {
		return {ctor: 'NewSearchDocs', _0: a, _1: b};
	});
var _user$project$Msg$NewSearchTerms = F2(
	function (a, b) {
		return {ctor: 'NewSearchTerms', _0: a, _1: b};
	});
var _user$project$Msg$NewSearchTopics = F2(
	function (a, b) {
		return {ctor: 'NewSearchTopics', _0: a, _1: b};
	});
var _user$project$Msg$NewTermTopics = F3(
	function (a, b, c) {
		return {ctor: 'NewTermTopics', _0: a, _1: b, _2: c};
	});
var _user$project$Msg$NewFrames = F3(
	function (a, b, c) {
		return {ctor: 'NewFrames', _0: a, _1: b, _2: c};
	});
var _user$project$Msg$NewTerms = F3(
	function (a, b, c) {
		return {ctor: 'NewTerms', _0: a, _1: b, _2: c};
	});
var _user$project$Msg$NewDocTokens = F3(
	function (a, b, c) {
		return {ctor: 'NewDocTokens', _0: a, _1: b, _2: c};
	});
var _user$project$Msg$NewDocs = F3(
	function (a, b, c) {
		return {ctor: 'NewDocs', _0: a, _1: b, _2: c};
	});
var _user$project$Msg$NewDocument = F2(
	function (a, b) {
		return {ctor: 'NewDocument', _0: a, _1: b};
	});
var _user$project$Msg$NewTopics = F3(
	function (a, b, c) {
...
var _user$project$Msg$UpdateSlot = F2(
	function (a, b) {
		return {ctor: 'UpdateSlot', _0: a, _1: b};
	});
var _user$project$Msg$ChoseSlotDialog = function (a) {
	return {ctor: 'ChoseSlotDialog', _0: a};
};
var _user$project$Msg$SlotToLastFromOther = function (a) {
	return {ctor: 'SlotToLastFromOther', _0: a};
};
var _user$project$Msg$RemoveSlotFromOther = function (a) {
	return {ctor: 'RemoveSlotFromOther', _0: a};
};
var _user$project$Msg$DeleteSlot = function (a) {
	return {ctor: 'DeleteSlot', _0: a};
};
var _user$project$Msg$Found = function (a) {
	return {ctor: 'Found', _0: a};
};
var _user$project$Msg$AdvancedSearch = function (a) {
	return {ctor: 'AdvancedSearch', _0: a};
};
var _user$project$Msg$Search = function (a) {
	return {ctor: 'Search', _0: a};
};
var _user$project$Msg$ResetSettings = {ctor: 'ResetSettings'};
var _user$project$Msg$OpenCheckMobile = F2(
	function (a, b) {
		return {ctor: 'OpenCheckMobile', _0: a, _1: b};
	});
var _user$project$Msg$Open = function (a) {
	return {ctor: 'Open', _0: a};
};
...
var _user$project$Request$loadTopics = function (slotId) {
	return A3(
		_user$project$Request$loadData,
		_user$project$Topic$decodeTopics,
		A2(_user$project$Msg$NewTopics, 'Topics', slotId),
		'getTopics');
};
var _user$project$Request$loadDoc = F2(
	function (slotId, doc) {
		return A3(
			_user$project$Request$loadData,
			_user$project$Document$documentDecoder,
			_user$project$Msg$NewDocument(slotId),
			A2(
				_elm_lang$core$Basics_ops['++'],
				'getDoc&DocId=',
				_elm_lang$core$Basics$toString(doc.id)));
	});
var _user$project$Request$loadDocTokens = F2(
	function (doc, slotId) {
		return A3(
			_user$project$Request$loadData,
			_user$project$Document$documentDecoder,
			A2(
				_user$project$Msg$NewDocTokens,
				A2(
					_elm_lang$core$Basics_ops['++'],
...
var _user$project$Request$loadBestDocs = F5(
	function (onResult, topic, maybeterm, sorting, slotId) {
		var name = function () {
			var _p0 = maybeterm;
			if (_p0.ctor === 'Just') {
		...
		var termArgument = function () {
			var _p1 = maybeterm;
			if (_p1.ctor === 'Just') {
				return A2(_elm_lang$core$Basics_ops['++'], '&term=', _p1._0.name);
			} else {
				return '';
			}
		}();
		...
		return A3(
			...
			A2(onResult, name, slotId),
			command);
	});
var _user$project$Request$loadTerms = F4(
	function (onResult, topic, offset, slotId) {
		var command = _elm_lang$core$String$concat(
			{
				ctor: '::',
				_0: 'getTerms&TopicId=',
...
var _user$project$Request$loadBestTerms = function (slotId) {
	return A3(
		_user$project$Request$loadData,
		_user$project$Term$bestTermsDecoder,
		A2(_user$project$Msg$NewTerms, 'Terms', slotId),
		'getBestTerms');
};
var _user$project$Request$loadAutocompleteTerms = F2(
	function (termName, slotId) {
		...
		return A3(
			...
			A2(_user$project$Msg$NewTermTopics, termName, slotId),
			command);
	});
var _user$project$Request$loadBestFrames = function (slotId) {
	return A3(
		_user$project$Request$loadData,
		_user$project$Term$bestTermsDecoder,
		A2(_user$project$Msg$NewFrames, 'Frames', slotId),
		'getBestFrames');
};
var _user$project$Request$loadSearchTopics = function (search) {
	var name = A2(_elm_lang$core$Basics_ops['++'], 'Search Result for ', search);
	var command = A2(_elm_lang$core$Basics_ops['++'], 'autocomplete&SearchWord=', search);
	return A3(
		_user$project$Request$loadData,
		_user$project$Term$searchTermDecoder,
		_user$project$Msg$NewSearchTopics(name),
		command);
};
var _user$project$Request$loadSearchTerms = function (search) {
	...
	return A3(
		_user$project$Request$loadData,
		_user$project$Term$searchTermDecoder,
		_user$project$Msg$NewSearchTerms(name),
		command);
};
var _user$project$Request$loadSearchDocs = F3(
	function (search, strict, sorting) {
		var name = A2(_elm_lang$core$Basics_ops['++'], 'Search Result for ', search);
		var command = _elm_lang$core$String$concat(
			{
				ctor: '::',
				_0: 'search&SearchWord=',
				_1: {
					ctor: '::',
					_0: search,
					_1: {
...
var _user$project$Request$getCombineTopics = F2(
	function (slotId, termName) {
		var command = A2(_elm_lang$core$Basics_ops['++'], 'autocomplete&SearchWord=', termName);
		return A3(
			_user$project$Request$loadData,
			_user$project$Term$searchTermDecoder,
			A2(_user$project$Msg$CombineTopic, slotId, termName),
			command);
	});
var _user$project$Request$getCombineDocs = F4(
	function (slotId, name, strict, sorting) {
		var command = _elm_lang$core$String$concat(
			{
				ctor: '::',
				_0: 'search&SearchWord=',
		...
		return A3(
			_user$project$Request$loadData,
			_user$project$Document$bestDocsDecoder,
			A2(_user$project$Msg$CombineDoc, slotId, name),
			command);
	});
var _user$project$Request$docsPageRequest = F4(
	function (topic, termArgument, meta, pagenumber) {
		var command = _elm_lang$core$String$concat(
			{
				ctor: '::',
				_0: 'bestDocs&TopicId=',
...
var _user$project$Request$createNewDocsContainer = F5(
	function (combine, model, topic, maybeterm, slotId) {
		var _p2 = function () {
			var _p3 = maybeterm;
			if (_p3.ctor === 'Just') {
				var _p4 = _p3._0;
		...
		var termArgument = _p2._0;
		var termName = _p2._1;
		var containerId = _elm_lang$core$Array$length(model.docsCache.arrayOfContainer);
		return A5(
			_user$project$Msg$NewDocsContainerSlot,
			combine,
			A2(
				_elm_lang$core$Basics_ops['++'],
				A2(
			...
			slotId,
			containerId,
			_user$project$Msg$ManageDocsCache(
				_user$project$ContainerCache$CreateNewContainer(
					A7(
						...
						containerId,
						_user$project$Document$bestDocsDecoder,
						A2(_user$project$Request$docsPageRequest, topic, termArgument)))));
	});
var _user$project$Request$termsPageRequest = F3(
	function (topic, meta, pagenumber) {
		var command = _elm_lang$core$String$concat(
			{
				ctor: '::',
				_0: 'getTerms&TopicId=',
...
var _user$project$Request$createNewTermsContainer = F4(
	function (combine, model, topic, slotId) {
		var containerId = _elm_lang$core$Array$length(model.termsCache.arrayOfContainer);
		return A6(
			_user$project$Msg$NewTermsContainerSlot,
			combine,
			A2(
				_elm_lang$core$Basics_ops['++'],
				'Terms in Topic ',
			...
			_user$project$Msg$ManageTermsCache(
				_user$project$ContainerCache$CreateNewContainer(
					A7(
						...
						containerId,
						_user$project$Term$termsDecoder,
						_user$project$Request$termsPageRequest(topic)))));
	});
...
var _user$project$Init$initDoc = function (id) {
	return _elm_lang$core$Native_Utils.update(
		_user$project$Document$defaultDoc,
		{id: id});
};
var _user$project$Init$initDocument = function (id) {
	return _elm_lang$core$Native_Utils.update(
		_user$project$Document$defaultDocument,
		{id: id});
};
var _user$project$Init$initSettings = {
	...
	search: false,
	search4: '',
	searchResult: _user$project$Model$TopicResult(
		{ctor: '[]'}),
	frame: _user$project$Model$Startpage
};
var _user$project$Init$init = {
	...
	_0: {
		...
		docsCache: A3(_user$project$ContainerCache$newContainerModel, _elm_lang$core$Array$empty, 10, _user$project$ContainerCache$defaultContainer),
		docsDict: _elm_lang$core$Dict$empty,
		mdl: _debois$elm_mdl$Material$model
	},
	_1: _elm_lang$core$Platform_Cmd$batch(
		{
			ctor: '::',
			_0: _user$project$Request$loadTopics(0),
			_1: {
				ctor: '::',
				_0: _debois$elm_mdl$Material_Layout$sub0(_user$project$Msg$Mdl),
				_1: {ctor: '[]'}
			}
		})
};
...
var _user$project$Update$scroll2Bottom = function (id) {
	return A2(
		_elm_lang$core$Task$attempt,
		function (a) {
			return _user$project$Msg$None;
		},
		_elm_lang$dom$Dom_Scroll$toBottom(id));
};
var _user$project$Update$scroll2Top = function (id) {
	return A2(
		_elm_lang$core$Task$attempt,
		function (a) {
			return _user$project$Msg$None;
		},
		_elm_lang$dom$Dom_Scroll$toTop(id));
};
var _user$project$Update$scroll2Right = A2(
	_elm_lang$core$Task$attempt,
	function (a) {
		return _user$project$Msg$None;
	},
	_elm_lang$dom$Dom_Scroll$toRight('board'));
var _user$project$Update$includeError = F2(
	function (model, err) {
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				settings: _elm_lang$core$Native_Utils.update(
					oldSettings,
					{
						error: _elm_lang$core$Basics$toString(err)
					})
			});
	});
			...
			switch (_p0.ctor) {
					...
					var _p34 = function () {
						...
						if ((_p35.ctor === 'Just') && (_p35._0.ctor === 'CombinedView')) {
							...
							return {
								ctor: '_Tuple2',
								_0: _user$project$Model$Empty('300px'),
								_1: _user$project$Model$Empty('300px')
							};
						}
					}();
				...
				case 'ManageDocsCache':
					...
					return {
						...
						_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Msg$ManageDocsCache, cmd)
					};
				case 'Batch':
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
				...
				case 'BatchCmd':
					return A2(_elm_lang$core$Platform_Cmd_ops['!'], model, _p0._0);
				case 'Mdl':
...
var _user$project$IconSet$primaryColor = _debois$elm_mdl$Material_Options$cs('primaryColor');
var _user$project$IconSet$iconHighlighted = F2(
	function (settings, id) {
		return {ctor: '[]'};
	});
var _user$project$IconSet$loadingView = function (width) {
	return A2(
		_debois$elm_mdl$Material_Options$div,
		{
			ctor: '::',
...
var _user$project$IconSet$moveActions = F7(
	function (cacheMsg, cache, containerId, slotId, actionHtml, actionStyle, innerHtml) {
		var thisCM = cache;
		var thisCache = A2(
			_elm_lang$core$Maybe$withDefault,
			_user$project$ContainerCache$defaultContainer,
		...
		return _elm_lang$core$List$concat(
			{
				...
				_0: _elm_lang$core$Native_Utils.eq(
					A2(
						_elm_lang$core$Maybe$withDefault,
						_user$project$ContainerCache$defaultContainer,
						A2(_elm_lang$core$Array$get, containerId, cache.arrayOfContainer)).meta.currPage,
					0) ? {ctor: '[]'} : {
					ctor: '::',
					_0: A2(
						actionHtml,
											...
											_user$project$Msg$Batch(
												{
													...
													_1: {
														...
														_0: A3(
															...
															-1,
															'',
															_user$project$Update$scroll2Bottom(
																A2(
																	_elm_lang$core$Basics_ops['++'],
																	'slot',
																	_elm_lang$core$Basics$toString(slotId)))),
															...
															_user$project$Msg$Batch(
																{
																	...
																	_1: {
																		...
																		_0: A3(
																			...
																			-1,
																			'',
																			_user$project$Update$scroll2Top(
																				A2(
																					_elm_lang$core$Basics_ops['++'],
																					'slot',
																					_elm_lang$core$Basics$toString(slotId)))),
...
var _user$project$IconSet$iconDocument = F2(
	function (mdl, args) {
		return A2(
			_debois$elm_mdl$Material_Options$span,
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A5(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('document'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$IconSet$iconDoc = F2(
	function (mdl, args) {
		return A2(
			_debois$elm_mdl$Material_Options$span,
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A5(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('doc'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$IconSet$iconTerm = F2(
	function (mdl, args) {
		return A2(
			_debois$elm_mdl$Material_Options$span,
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A5(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('term'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$IconSet$iconTopicDetail = F2(
	function (mdl, args) {
		return A2(
			_debois$elm_mdl$Material_Options$span,
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A5(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('topic details'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$IconSet$iconTopic = F2(
	function (mdl, args) {
		return A2(
			_debois$elm_mdl$Material_Options$span,
			{ctor: '[]'},
...
var _user$project$IconSet$iconHome = F2(
	function (mdl, args) {
		return A2(
			_debois$elm_mdl$Material_Options$span,
			{
				ctor: '::',
				_0: _debois$elm_mdl$Material_Options$cs('homeIcon'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
								...
								_1: {
									...
									_0: _debois$elm_mdl$Material_Options$onClick(
										A3(
											...
											slotId + 1,
											'1000px',
											A2(_user$project$Request$loadDoc, slotId + 1, doc))),
									_1: {ctor: '[]'}
								}
							}
						}
	...
	function (model, flex, slotId, slotName, withHead) {
		return A2(
			_debois$elm_mdl$Material_Options$div,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$core$Native_Utils.eq(model.settings.frame, _user$project$Model$Mobile) ? A2(_debois$elm_mdl$Material_Options$css, 'width', '100%') : flex,
					_1: {
						ctor: '::',
						_0: _debois$elm_mdl$Material_Elevation$e0,
						_1: {
			...
			},
			{
				...
				_0: withHead ? A2(
					_debois$elm_mdl$Material_Options$div,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$core$Native_Utils.eq(model.settings.frame, _user$project$Model$Mobile) ? A2(_debois$elm_mdl$Material_Options$css, 'width', '100%') : A2(_debois$elm_mdl$Material_Options$css, 'max-width', '400px'),
							_1: {
								ctor: '::',
								_0: _debois$elm_mdl$Material_Options$center,
								_1: {ctor: '[]'}
												...
												_1: {
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _debois$elm_mdl$Material_Options$onClick(
																_user$project$Msg$DeleteSlot(slotId)),
															_1: {ctor: '[]'}
														}
													}
												}
					...
					_0: A2(
						_debois$elm_mdl$Material_Options$div,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: A2(_debois$elm_mdl$Material_Options$css, 'padding', '8px 0 0 0'),
									_1: {
										ctor: '::',
										_0: _debois$elm_mdl$Material_Options$id(
											A2(
												_elm_lang$core$Basics_ops['++'],
												'slot',
												_elm_lang$core$Basics$toString(slotId))),
						...
						A7(
							_user$project$IconSet$moveActions,
							_user$project$Msg$ManageDocsCache,
							model.docsCache,
							A2(
								_elm_lang$core$Maybe$withDefault,
								0,
								A2(_elm_lang$core$Dict$get, slotName, model.docsDict)),
							slotId,
							F2(
								function (x, y) {
									return A2(
										...
										{
											ctor: '::',
											_0: A2(_debois$elm_mdl$Material_Card$title, x, y),
											_1: {ctor: '[]'}
										});
								}),
							{ctor: '[]'},
							A3(
								_elm_lang$core$List$map2,
								_user$project$Documentsview$doc2CardView(slotId),
								model.docs,
								A2(
									_elm_lang$core$List$range,
									1,
...
var _user$project$Startpage$view = function (settings) {
	return A2(
		_debois$elm_mdl$Material_Options$div,
		{
			ctor: '::',
			...
			_0: A2(
				_debois$elm_mdl$Material_Options$div,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A2(_debois$elm_mdl$Material_Options$css, 'heigth', '100%'),
							_1: {
								ctor: '::',
								_0: A2(_debois$elm_mdl$Material_Options$css, 'margin-top', '-50px'),
								_1: {ctor: '[]'}
							}
						}
					}
				},
				{
					...
					_0: A2(
						_debois$elm_mdl$Material_Card$view,
						{
							...
							_1: {
								ctor: '::',
								_0: _debois$elm_mdl$Material_Options$cs('startpage-card'),
								_1: {
									ctor: '::',
									_0: _debois$elm_mdl$Material_Options$onClick(
										A2(_user$project$Msg$OpenCheckMobile, _user$project$Model$ViewTopics, _user$project$Model$Mobile)),
									_1: {ctor: '[]'}
								}
							}
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: A2(_debois$elm_mdl$Material_Options$css, 'height', '225px'),
									_1: {ctor: '[]'}
								},
								{ctor: '[]'}),
							_1: {
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('View Topics'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Browse topics to get an overview over the data.'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
					...
					},
					{
						...
						_0: A2(
							_debois$elm_mdl$Material_Card$view,
							{
								...
								_1: {
									ctor: '::',
									_0: _debois$elm_mdl$Material_Options$cs('startpage-card-disabled'),
									_1: {ctor: '[]'}
								}
							},
							{
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Topic Statistics'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Timelines and other Statistics about a Topic or all Topics.'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Compare Topics'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Compare two or more Topics and join Topics together.'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
...
var _user$project$Showdocumentview$document2DocumentView = function (document) {
	return A2(
		_debois$elm_mdl$Material_Options$div,
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: A2(_debois$elm_mdl$Material_Options$css, 'height', 'calc(100% - 97px)'),
				_1: {ctor: '[]'}
			}
		},
		{
				...
				_1: {
					...
					_0: A2(
						_debois$elm_mdl$Material_Options$div,
						{
							...
							_1: {
								ctor: '::',
								_0: A2(_debois$elm_mdl$Material_Options$css, 'height', 'inherit'),
								_1: {ctor: '[]'}
							}
						},
						{
...
var _user$project$Showdocumentview$view = F4(
	function (model, document, flex, slotId) {
		return A2(
			_debois$elm_mdl$Material_Options$div,
			{
				ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A2(_debois$elm_mdl$Material_Options$css, 'box-shadow', '0 0 10px rgba(0, 0, 0, 0.80)'),
							_1: {
								ctor: '::',
								_0: _debois$elm_mdl$Material_Elevation$e0,
								_1: {
			...
			},
			{
				...
				_0: A2(
					...
					},
					{
						ctor: '::',
						_0: A2(
							_user$project$IconSet$iconDocument,
							model.mdl,
							{
								ctor: '::',
								_0: A2(_debois$elm_mdl$Material_Options$css, 'margin', '5px'),
				...
				_1: {
					ctor: '::',
					_0: _user$project$Showdocumentview$document2DocumentView(document),
					_1: {ctor: '[]'}
				}
			});
	});
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(_debois$elm_mdl$Material_Options$css, 'width', 'calc(100% - 58px)'),
								_1: {
									ctor: '::',
										...
										_1: {
											...
											_0: _debois$elm_mdl$Material_Options$onClick(
												_user$project$Msg$Batch(
													{
														ctor: '::',
														_0: A5(_user$project$Request$createNewDocsContainer, true, model, topic, _elm_lang$core$Maybe$Nothing, slotId + 1),
														_1: {
															ctor: '::',
															_0: A4(_user$project$Request$createNewTermsContainer, true, model, topic, slotId + 1),
															_1: {
																ctor: '::',
																_0: A3(_user$project$Msg$ExecCmd, slotId + 1, '600px', _elm_lang$core$Platform_Cmd$none),
																_1: {ctor: '[]'}
															}
														}
													})),
						...
						_1: {
							...
							_0: A2(
								_debois$elm_mdl$Material_Options$span,
								{
									ctor: '::',
									_0: _debois$elm_mdl$Material_Options$onClick(
										A4(_user$project$Request$createNewTermsContainer, false, model, topic, slotId + 1)),
									_1: {
										ctor: '::',
										_0: _debois$elm_mdl$Material_Options$center,
										_1: {ctor: '[]'}
								...
								},
								{
									ctor: '::',
									_0: A2(
										_user$project$IconSet$iconTerm,
										mdl,
										A2(
											_user$project$IconSet$iconHighlighted,
											settings,
							...
							_1: {
								...
								_0: A2(
									_debois$elm_mdl$Material_Options$span,
									{
										ctor: '::',
										_0: _debois$elm_mdl$Material_Options$onClick(
											A5(_user$project$Request$createNewDocsContainer, false, model, topic, _elm_lang$core$Maybe$Nothing, slotId + 1)),
										_1: {
											ctor: '::',
											_0: _debois$elm_mdl$Material_Options$center,
											_1: {ctor: '[]'}
			...
			},
			{
				...
				_0: A2(
					...
					},
					{
						ctor: '::',
						_0: A2(
							_user$project$IconSet$iconTopic,
							model.mdl,
							{
								ctor: '::',
								_0: A2(_debois$elm_mdl$Material_Options$css, 'margin', '5px'),
											...
											_1: {
												...
												_1: {
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$core$Native_Utils.eq(slotId, 0) ? _debois$elm_mdl$Material_Options$disabled(true) : _debois$elm_mdl$Material_Options$disabled(false),
															_1: {ctor: '[]'}
														}
													}
												}
...
var _user$project$Termsview$terms2ListItem = F5(
	function (model, parent, slotId, id, term) {
		return A2(
						...
						_0: A2(
							_debois$elm_mdl$Material_Options$span,
							{
								...
								_1: {
									...
									_0: _debois$elm_mdl$Material_Options$onClick(
										A5(
											_user$project$Request$createNewDocsContainer,
											false,
											model,
											parent,
							...
							{
								ctor: '::',
								_0: model.settings.showRelevance ? _elm_lang$html$Html$text(
									A2(
										_elm_lang$core$Basics_ops['++'],
										term.name,
										A2(
											...
											A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(
													A2(_elm_lang$core$Maybe$withDefault, 0, term.relevance)),
												')')))) : _elm_lang$html$Html$text(term.name),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
								...
								_debois$elm_mdl$Material_Options$span,
								{
									...
									_0: _debois$elm_mdl$Material_Options$onClick(
										A3(
											...
											slotId + 1,
											'300px',
											A2(_user$project$Request$loadAutocompleteTerms, term.name, slotId + 1))),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
...
var _user$project$Termsview$view = F6(
	function (model, flex, slotId, slotName, parent, withHead) {
		return A2(
			_debois$elm_mdl$Material_Options$div,
			{
				ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						A7(
							...
							F2(
								function (x, y) {
									return A2(
										...
										{
											ctor: '::',
											_0: A2(_debois$elm_mdl$Material_List$content, x, y),
											_1: {ctor: '[]'}
										});
								}),
							{
							...
							A2(
								_elm_lang$core$List$indexedMap,
								A3(_user$project$Termsview$terms2ListItem, model, parent, slotId),
								model.terms))),
					_1: {ctor: '[]'}
				}
			});
...
var _user$project$TermsDocumentsview$view = F4(
	function (model, flex, slotId, name) {
		return A2(
			_debois$elm_mdl$Material_Options$div,
			{
				ctor: '::',
			...
			},
			{
				...
				_0: A2(
					...
					},
					{
						ctor: '::',
						_0: A2(
							_user$project$IconSet$iconTopicDetail,
							model.mdl,
							{
								ctor: '::',
								_0: A2(_debois$elm_mdl$Material_Options$css, 'margin', '5px'),
					...
					_0: A2(
						...
						},
						{
							...
							_0: A6(
								...
								model,
								A2(_debois$elm_mdl$Material_Options$css, 'flex', '1 1 50%'),
								slotId,
								'',
								_user$project$Topic$defaultTopic,
								false),
...
var _user$project$Searchview$li = F3(
...
var _user$project$Searchview$searchresult2ListItems = function (result) {
	var _p0 = result;
	switch (_p0.ctor) {
		case 'TermResult':
			var lia = function (a) {
				return A3(
					_user$project$Searchview$li,
					'list',
					a.name,
					_user$project$Msg$BatchCmd(
						{
							ctor: '::',
							_0: A4(_user$project$Request$getCombineDocs, 0, a.name, false, 'RELEVANCE'),
							_1: {
								ctor: '::',
								_0: A2(_user$project$Request$getCombineTopics, 0, a.name),
								_1: {ctor: '[]'}
							}
						}));
			};
...
var _user$project$Searchview$advancedSearch = function (search4) {
	return {
		ctor: '::',
		_0: function () {
			if (A2(_elm_lang$core$String$startsWith, 'topic:', search4)) {
				var search4topic = A2(_elm_lang$core$String$dropLeft, 6, search4);
				return A3(
					_user$project$Searchview$li,
					'bubble_chart',
					A2(_elm_lang$core$Basics_ops['++'], 'Search for Topics with ', search4topic),
					A3(
						_user$project$Msg$ExecCmd,
						1,
						'300px',
						_user$project$Request$loadSearchTopics(search4topic)));
			} else {
				return A2(
					_debois$elm_mdl$Material_Options$span,
					{ctor: '[]'},
		...
		_1: {
			ctor: '::',
			_0: function () {
				if (A2(_elm_lang$core$String$startsWith, 'term:', search4)) {
					var search4term = A2(_elm_lang$core$String$dropLeft, 5, search4);
					return A3(
						_user$project$Searchview$li,
						'list',
						A2(_elm_lang$core$Basics_ops['++'], 'Search for Terms with ', search4term),
						A3(
							_user$project$Msg$ExecCmd,
							1,
							'300px',
							_user$project$Request$loadSearchTerms(search4term)));
				} else {
					return A2(
						_debois$elm_mdl$Material_Options$span,
						{ctor: '[]'},
			...
			_1: {
				ctor: '::',
				_0: function () {
					if (A2(_elm_lang$core$String$startsWith, 'document:', search4)) {
						var search4doc = A2(_elm_lang$core$String$dropLeft, 9, search4);
						return A3(
							_user$project$Searchview$li,
							'art_track',
							A2(_elm_lang$core$Basics_ops['++'], 'Search for Documents with ', search4doc),
							A3(
								_user$project$Msg$ExecCmd,
								1,
								'300px',
								A3(_user$project$Request$loadSearchDocs, search4doc, false, 'RELEVANCE')));
					} else {
						return A2(
							_debois$elm_mdl$Material_Options$span,
							{ctor: '[]'},
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					_user$project$Searchview$searchresult2ListItems(model.settings.searchResult)),
				_1: {ctor: '[]'}
			});
	});

var _user$project$Mainview_v4$arrawRight = F2(
	function (name, slotId) {
		return A2(
			_debois$elm_mdl$Material_Options$span,
			{
				ctor: '::',
				_0: A2(_debois$elm_mdl$Material_Options$css, 'margin-left', '1px'),
				_1: {
					ctor: '::',
					_0: A2(_debois$elm_mdl$Material_Options$css, 'padding', '14px 4px 2px 2px'),
					_1: {
						ctor: '::',
						_0: A2(_debois$elm_mdl$Material_Options$css, 'border', '2px solid #78909c'),
						_1: {
							ctor: '::',
							_0: A2(_debois$elm_mdl$Material_Options$css, 'border-radius', '3px 6px 6px 3px'),
							_1: {
								ctor: '::',
								...
								_1: {
									ctor: '::',
									_0: _debois$elm_mdl$Material_Options$onClick(
										_user$project$Msg$DeleteSlot(slotId + 1)),
									_1: {ctor: '[]'}
								}
							}
						}
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _debois$elm_mdl$Material_Options$cs('arrawRight'),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {
...
var _user$project$Mainview_v4$toHistoryButton = F2(
	function (slotId, view) {
		var _p0 = view;
		switch (_p0.ctor) {
			case 'TopicsView':
				return A2(_user$project$Mainview_v4$arrawRight, _p0._0, slotId);
			case 'TermsDocumentsView':
				return A2(_user$project$Mainview_v4$arrawRight, _p0._0, slotId);
			case 'TermsView':
				return A2(_user$project$Mainview_v4$arrawRight, _p0._0, slotId);
			case 'DocumentsView':
			...
			case 'ShowdocumentView':
				return A2(_user$project$Mainview_v4$arrawRight, _p0._0.title, slotId);
			case 'TermsContainerSlot':
				return A2(_user$project$Mainview_v4$arrawRight, _p0._0, slotId);
			case 'DocsContainerSlot':
				return A2(_user$project$Mainview_v4$arrawRight, _p0._0, slotId);
			case 'CombinedView':
				return A2(_user$project$Mainview_v4$arrawRight, _p0._0, slotId);
			default:
				return A2(_user$project$Mainview_v4$arrawRight, ' ... ', slotId);
		}
	});
var _user$project$Mainview_v4$slot = F3(
	function (model, slotId, view) {
		...
		switch (_p1.ctor) {
			...
			case 'TermsDocumentsView':
				return A4(
					_user$project$TermsDocumentsview$view,
					_elm_lang$core$Native_Utils.update(
						model,
						{terms: _p1._1, docs: _p1._2}),
					A2(_debois$elm_mdl$Material_Options$css, 'width', '600px'),
					slotId,
					_p1._0);
			case 'TermsView':
				return A6(
			...
			case 'ShowdocumentView':
				return A4(
					_user$project$Showdocumentview$view,
					model,
					_p1._0,
			...
			case 'TermsContainerSlot':
				...
				var inContainer = A2(
					...
					A2(
						_elm_lang$core$Maybe$withDefault,
						0,
						A2(_elm_lang$core$Dict$get, _p3, model.termsDict)));
				var _p2 = inContainer;
				if (_p2.ctor === 'Just') {
					return A6(
						_user$project$Termsview$view,
					...
					return _user$project$IconSet$loadingView('300px');
				}
			case 'DocsContainerSlot':
				var _p5 = _p1._0;
				var inContainer = A2(
					...
					A2(
						_elm_lang$core$Maybe$withDefault,
						0,
						A2(_elm_lang$core$Dict$get, _p5, model.docsDict)));
				var _p4 = inContainer;
				if (_p4.ctor === 'Just') {
					return A5(
						_user$project$Documentsview$view,
						...
						_0: A2(
							_debois$elm_mdl$Material_Options$div,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: A2(_debois$elm_mdl$Material_Options$css, 'overflow-y', 'hidden'),
										_1: {
											ctor: '::',
											_0: A2(_debois$elm_mdl$Material_Options$css, 'height', '100%'),
											_1: {ctor: '[]'}
							...
							{
								ctor: '::',
								_0: A3(_user$project$Mainview_v4$slot, model, slotId, _p1._1),
								_1: {
									ctor: '::',
									_0: A3(_user$project$Mainview_v4$slot, model, slotId, _p1._2),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
			...
			case 'Empty':
				return _user$project$IconSet$loadingView(_p1._0);
			default:
				return A2(
					_debois$elm_mdl$Material_Options$div,
					{
...
var _user$project$Mainview_v4$viewBody = function (model) {
	var _p6 = model.settings.frame;
	switch (_p6.ctor) {
		case 'Startpage':
			return _user$project$Startpage$view(model.settings);
		case 'Mobile':
			var listLengthSub1 = _elm_lang$core$List$length(model.slots) - 1;
			return A2(
				_debois$elm_mdl$Material_Options$div,
				{
					ctor: '::',
				...
				},
				{
					...
					_0: A2(
						_debois$elm_mdl$Material_Options$div,
						{ctor: '[]'},
						A2(_elm_lang$core$List$indexedMap, _user$project$Mainview_v4$toHistoryButton, model.slots)),
					_1: {
						ctor: '::',
						_0: A2(
							_debois$elm_mdl$Material_Options$div,
							...
							},
							{
								ctor: '::',
								_0: A3(
									_user$project$Mainview_v4$slot,
									model,
									listLengthSub1,
									A2(
										_elm_lang$core$Maybe$withDefault,
										_user$project$Model$Empty('100%'),
										_elm_lang$core$List$head(
											_elm_lang$core$List$reverse(model.slots)))),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
			...
			return A2(
				...
				},
				{
					...
					_0: A2(
								...
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _debois$elm_mdl$Material_Options$id('board'),
												_1: {ctor: '[]'}
											}
										}
									}
						...
						A2(
							_elm_lang$core$List$indexedMap,
							_user$project$Mainview_v4$slot(model),
							model.slots)),
					_1: {ctor: '[]'}
				});
	}
};
var _user$project$Mainview_v4$viewSwitch = function (model) {
	var oldSettings = model.settings;
	return A2(
		_debois$elm_mdl$Material_Options$div,
		{ctor: '[]'},
...
var _user$project$Mainview_v4$onEnterPressed = function (msg) {
...
var _user$project$Mainview_v4$viewSearch = function (model) {
	return A2(
		_debois$elm_mdl$Material_Options$span,
		{
			ctor: '::',
				...
				model.mdl,
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _debois$elm_mdl$Material_Options$onInput(_user$project$Msg$Search),
								_1: {
									ctor: '::',
									_0: _user$project$Mainview_v4$onEnterPressed(
										_user$project$Msg$AdvancedSearch(model.settings.search4)),
									_1: {
										ctor: '::',
										_0: _debois$elm_mdl$Material_Options$dispatch(_user$project$Msg$Batch),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$Mainview_v4$view = function (model) {
	var settings = model.settings;
	return A3(
		...
		A4(
			...
			{
				header: _elm_lang$core$Native_Utils.eq(settings.error, '') ? {
					ctor: '::',
					_0: A2(
						_debois$elm_mdl$Material_Options$span,
						{ctor: '[]'},
				...
				drawer: {
					ctor: '::',
					_0: _user$project$Mainview_v4$viewSwitch(model),
					_1: {ctor: '[]'}
				},
				tabs: {
					ctor: '_Tuple2',
				...
				main: {
					...
					_0: settings.search ? A2(
						_debois$elm_mdl$Material_Options$span,
						{
							...
							_1: {
								ctor: '::',
								_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Msg$ResetSettings),
								_1: {ctor: '[]'}
							}
						},
						{
							...
							_0: A2(
								...
								model,
								A2(_debois$elm_mdl$Material_Options$css, 'flex', '1 1 100%')),
							_1: {ctor: '[]'}
						}) : A2(
						_debois$elm_mdl$Material_Options$span,
						{ctor: '[]'},
					...
					_1: {
						ctor: '::',
						_0: _user$project$Mainview_v4$viewBody(model),
						_1: {ctor: '[]'}
					}
				}
			}));
...
var _user$project$TE_elm_v2$subscriptions = function (model) {
	return A2(_debois$elm_mdl$Material_Layout$subs, _user$project$Msg$Mdl, model.mdl);
};
var _user$project$TE_elm_v2$view = function (model) {
	return _user$project$Mainview_v4$view(model);
};
var _user$project$TE_elm_v2$main = _elm_lang$html$Html$program(
...
Elm['IconSet'] = Elm['IconSet'] || {};
if (typeof _user$project$IconSet$main !== 'undefined') {
    _user$project$IconSet$main(Elm['IconSet'], 'IconSet', {"types":null,"versions":{"elm":"0.18.0"}});
}
Elm['Init'] = Elm['Init'] || {};
if (typeof _user$project$Init$main !== 'undefined') {
    _user$project$Init$main(Elm['Init'], 'Init', {"types":null,"versions":{"elm":"0.18.0"}});
}
Elm['Mainview_v4'] = Elm['Mainview_v4'] || {};
if (typeof _user$project$Mainview_v4$main !== 'undefined') {
    _user$project$Mainview_v4$main(Elm['Mainview_v4'], 'Mainview_v4', {"types":null,"versions":{"elm":"0.18.0"}});
}
Elm['Model'] = Elm['Model'] || {};
